...

    {
...

        {
            ...
            if (presence != nullptr) {
                ...
                if((presence->button1text && presence->button1text[0] && presence->button1url && presence->button1url[0]) ||
                    (presence->button2text && presence->button2text[0] && presence->button2url && presence->button2url[0])) {
